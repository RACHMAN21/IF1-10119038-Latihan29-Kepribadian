package if1.latihan29.kepribadian;
 ...
 * KELAS : IF-1
 * NIM   : 10119038
 * Dekripsi Program : program ini berisi untuk menampilkan hasil kepribadian
 *                    dari pilihan yg dipilih oleh seorang user
 */
...
public class Kepribadian {
    ...
    private String menentukanKepribadian(){
        ...
        switch (this.warna) {
            ...
            case "UNGU" :
                ...
                break;
            default:
                warna = "Oops.. Belum teridentifikasi, Ulangi!";
        }
        return warna;
    }
    ...
    public static void main(String[] args) {
	    Kepribadian kepribadian = new Kepribadian();
            kepribadian.masukkanWarna();
            kepribadian.tampilTest();
